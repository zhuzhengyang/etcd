...
import "github.com/zhuzhengyang/etcd/Godeps/_workspace/src/github.com/coreos/pkg/capnslog"

var (
	plog = capnslog.NewPackageLogger("github.com/zhuzhengyang/etcd/etcdserver", "stats")
)
